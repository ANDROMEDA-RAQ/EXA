...
# Configure main_frame for two columns
main_frame.columnconfigure(0, weight=1)
main_frame.columnconfigure(1, weight=1)

# Example of adding widgets in two columns:
label1 = tk.Label(main_frame, text="Column 1", bg="blue", fg="white")
label1.grid(row=0, column=0, padx=5, pady=5, sticky="nsew")

label2 = tk.Label(main_frame, text="Column 2", bg="red", fg="white")
label2.grid(row=0, column=1, padx=5, pady=5, sticky="nsew")

# Here, we're not adding any image to the main_frame
